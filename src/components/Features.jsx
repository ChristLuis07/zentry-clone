...
const BentoTilt = ({Children, className = ""}) => {
    ...
    const handleMouseMove = (e) => {
        ...
        rotateX(${tiltX}deg) rotateY(${tiltY}deg) scale3d(0.98, 0.98, 0.98)`;
      ...
      <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
            <BentoCard
                ...
                title={<>zig<b>m</b>a</>}
                description="An anime and gaming-inspired NFT collection - the IP 
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
            <BentoCard
                ...
                title={<>n<b>e</b>xus</>}
                description="A gamified social hub, adding a new dimension to the social 
          ...
          <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
            <BentoCard
                ...
                title={<>az<b>u</b>l</>}
                description="A cross-world AI Agent - elevating your gameplay to 
